namespace CatchButton
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // scoreBox
            // 
            scoreBox.Font = new Font("맑은 고딕", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 129);
            scoreBox.Location = new Point(699, 2);
            scoreBox.Name = "scoreBox";
            scoreBox.Size = new Size(100, 25);
            scoreBox.TabIndex = 1;
            scoreBox.Text = "현재 점수: 0";
            // 
            // lifeBox
            // 
            lifeBox.Font = new Font("맑은 고딕", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 129);
            lifeBox.Location = new Point(1, 2);
            lifeBox.Name = "lifeBox";
            lifeBox.Size = new Size(100, 25);
            lifeBox.TabIndex = 2;
            lifeBox.Text = "남은 목숨: 20";
            // 
            // reset
            // 
            reset.BackColor = SystemColors.Info;
            reset.Font = new Font("맑은 고딕", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 129);
            reset.Location = new Point(1, 419);
            reset.Name = "reset";
            reset.Size = new Size(88, 32);
            reset.TabIndex = 3;
            reset.Text = "다시 시작";
            reset.UseVisualStyleBackColor = false;
            reset.MouseClick += button1_Click;
            // 
            // Form1
            // 
